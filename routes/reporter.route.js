...
router.get('/category', async function (req, res) {
    ...
    // const limit = 2 // số lượng có thể coi
    // const page = +req.query.page || 1; // trang hiện tại
    // const offset = (page-1)*limit;
    // //const offset = req.query.offset || 0; // vị trí bắt đầu lấy dữ liệu
    // const list = await newsService.findPageByCatId(id,limit,offset);
    // const total  = await newsService.countByCatId(id);
    ...
    //     page_items.push({
    //         value: i,
    //         active:i===page // kiểm tra acctive có bằng page hay không
    //     })
    // }
...
router.post('/editnews', async function(req, res){
    ...
    // console.log(id);
     //console.log(article);
     console.log(req.body.abstract, article.Abstract)
    let nameThumnail = ''
